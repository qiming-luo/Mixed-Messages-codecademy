// the goal is to randomly pick 2 different workouts(each workout time randomly assigned, can be same or different) in a randomly picked day.
 
// format: 'Monday', 'jogging 30minutes ; tai chi 30 minutes'


function workoutplaner(obj){
...
let workoutForADay = workoutplaner(combos);
